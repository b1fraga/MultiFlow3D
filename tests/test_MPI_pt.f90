...
subroutine collect_MPI_pt(tests)
  ...
  tests = [ &
       ...
       new_unittest("MPI_pt distributes particles to 4 ranks for Lcol=true", test_MPI_pt_four_ranks_lcol_true) &
  ]
...
subroutine test_MPI_pt_four_ranks_lcol_true(error)
...
end subroutine test_MPI_pt_four_ranks_lcol_true
