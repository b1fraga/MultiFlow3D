...
!====================================================================
 ...
 !             if (LENERGY) dm(21)=dom(ib)%Tm(i,j,k)
                    ...
                    dm(11),dm(12),dm(13),dm(14),dm(15),dm(16),dm(18),dm(19)
                    !,dm(19), &
                    !dm(20)
                      end do
                  end do
