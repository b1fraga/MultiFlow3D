...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                    ...
                    /dom(ib)%dx
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                          if(dom(ib)%voo(i,j-1,k)>0.0_dp) then
                    ...
                    /dom(ib)%dy
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                          if(dom(ib)%woo(i,j,k-1)>0.0_dp) then
...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ Difusion
                    ...
                    atT*dom(ib)%epso(i,j,k+1) + abT*dom(ib)%epso(i,j,k-1))
                          ...
                          other=c2eps*dom(ib)%epso(i,j,k)**2.0_dp/dom(ib)%ksgso(i,j,k)         !destruction
