...
!=======================================================================
!######################################################################
      function phi_r1smth(r) result(val)
!######################################################################
...
!######################################################################
      function phi_r2smth(r) result(val)
!######################################################################
          use, intrinsic :: iso_fortran_env, only: dp => real64
          implicit none
          real(dp), intent(in) :: r
...
!######################################################################
      function phi_r3smth2(r) result(val)
!######################################################################
          use, intrinsic :: iso_fortran_env, only: dp => real64
          implicit none
          real(dp), intent(in) :: r
...
!######################################################################
      function phi_r3smth(r) result(val)
!######################################################################
          use, intrinsic :: iso_fortran_env, only: dp => real64
          implicit none
          real(dp), intent(in) :: r
...
!######################################################################
      function phi_r4smth(r) result(val)
!######################################################################
          use, intrinsic :: iso_fortran_env, only: dp => real64
          implicit none
          real(dp), intent(in) :: r
...
!######################################################################
      function dh(dx,dy,dz,xij,yij,zij,Xl,Yl,Zl,order) result(val)
!######################################################################
...
!######################################################################
      function ddh(dx,dy,dz,xij,yij,zij,Xl,Yl,Zl,order,dir) result(val)
!######################################################################
          use, intrinsic :: iso_fortran_env, only: dp => real64
          implicit none
