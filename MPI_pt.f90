...
!       integer :: nxdom_corprev1,nydom_corprev1,nzdom_corprev1
!       integer :: nxdom_corprev2,nydom_corprev2,nzdom_corprev2
!       integer :: nxdom_corprev3,nydom_corprev3,nzdom_corprev3
!       integer :: nxdom_corprev4,nydom_corprev4,nzdom_corprev4
!       integer :: nxdom_cornext1,nydom_cornext1,nzdom_cornext1
!       integer :: nxdom_cornext2,nydom_cornext2,nzdom_cornext2
!       integer :: nxdom_cornext3,nydom_cornext3,nzdom_cornext3
!       integer :: nxdom_cornext4,nydom_cornext4,nzdom_cornext4

!       integer :: nxdom_edgprev1,nydom_edgprev1,nzdom_edgprev1
!       integer :: nxdom_edgprev2,nydom_edgprev2,nzdom_edgprev2
!       integer :: nxdom_edgprev3,nydom_edgprev3,nzdom_edgprev3
!       integer :: nxdom_edgprev4,nydom_edgprev4,nzdom_edgprev4
!       integer :: nxdom_edgprev5,nydom_edgprev5,nzdom_edgprev5
!       integer :: nxdom_edgprev6,nydom_edgprev6,nzdom_edgprev6
!       integer :: nxdom_edgnext1,nydom_edgnext1,nzdom_edgnext1
!       integer :: nxdom_edgnext2,nydom_edgnext2,nzdom_edgnext2
!       integer :: nxdom_edgnext3,nydom_edgnext3,nzdom_edgnext3
...
!           write(6,*)'1',o,ptsinproc(o)
          ...
          do oo=1,nprocs
              iii=1
              DO ll=1,np
!              write(myrank+2000,*) oo,ll,
!     &           lpt_proc_edgprev1(ll),lpt_proc_edgprev2(ll),
!     &           lpt_proc_edgprev3(ll),lpt_proc_edgprev3(ll),
!     &           lpt_proc_edgprev5(ll),lpt_proc_edgprev6(ll),
!     &           lpt_proc_edgnext1(ll),lpt_proc_edgnext2(ll),
!     &           lpt_proc_edgnext3(ll),lpt_proc_edgnext4(ll),
!     &           lpt_proc_edgnext5(ll),lpt_proc_edgnext6(ll)

!               lpt_proc_corprev1(ll),
!     &           lpt_proc_corprev2(ll),lpt_proc_corprev3(ll),
!     &           lpt_proc_corprev4(ll),lpt_proc_cornext1(ll),
!     &           lpt_proc_cornext2(ll),
...
!     &           (lpt_proc_corprev4(ll).eq.(oo)).or.
!     &           (lpt_proc_cornext1(ll).eq.(oo)).or.
!     &           (lpt_proc_cornext2(ll).eq.(oo)).or.
!     &           (lpt_proc_cornext3(ll).eq.(oo)).or.
!     &           (lpt_proc_cornext4(ll).eq.(oo)).or.
!     &           (lpt_proc_edgprev1(ll).eq.(oo)).or.
!     &           (lpt_proc_edgprev2(ll).eq.(oo)).or.
!     &           (lpt_proc_edgprev3(ll).eq.(oo)).or.
!     &           (lpt_proc_edgprev4(ll).eq.(oo)).or.
!     &           (lpt_proc_edgprev5(ll).eq.(oo)).or.
!     &           (lpt_proc_edgprev6(ll).eq.(oo)).or.
!     &           (lpt_proc_edgnext1(ll).eq.(oo)).or.should
!     &           (lpt_proc_edgnext2(ll).eq.(oo)).or.
!     &           (lpt_proc_edgnext3(ll).eq.(oo)).or.
!     &           (lpt_proc_edgnext4(ll).eq.(oo)).or.
!     &           (lpt_proc_edgnext5(ll).eq.(oo)).or.
!     &           (lpt_proc_edgnext6(ll).eq.(oo))) then

!                       write(myrank+1000,*) iii+npt*(oo-1),ll,zp_pt(ll)
