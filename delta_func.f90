...
!######################################################################
          ...
          phi_r2smth= -1.0_dp/8./PI*(-5.0_dp*PI-2.0_dp*PI*r+4.0_dp*sin(PI/4.0_dp*(-2.0_dp*r-1.0_dp)))
...
!      real :: PI
          ...
          scal1 = 1.095450017660160615261  ! 55.0_dp/48.0_dp - sqrt(3.0_dp)*pi/108.0_dp
          scal2 = 1.083333333333333333333  ! 13.0_dp/12.0_dp
          scal3 = 0.4045499823398393847387 ! 17.0_dp/48.0_dp + sqrt(3.0_dp)*pi/108.0_dp
          scal4 = 0.0481125224324688137091 ! sqrt(3.0_dp)/36.0_dp
          scal5 = 0.1443375672974064411273 ! sqrt(3.0_dp)/12.0_dp
          scal6 = 0.8660254037844386467637 ! sqrt(3.0_dp)/2.0_dp
